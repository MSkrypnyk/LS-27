          ...
          <div className="contact-blocks">
            <div className="contact-info-block">
              <div className="contact-info-image-block">
                <img src={Ellipse} alt="" />
                <img className="contact-info-icon" src={CountryImage} alt="" />
              </div>
            ...
            <div className="contact-info-block">
              <div className="contact-info-image-block">
                <img src={Ellipse} alt="" />
                <img className="contact-info-icon" src={EmailImage} alt="" />
              </div>
              <div className="contact-info-main">
                <div className="contact-info-main-block">
                  <p className="contact-info-title">Email:</p>
                  <a href="/" className="contact-info-description">
                    youremail@gmail.com
                  </a>
                </div>
                <div className="contact-info-main-block">
                  <p className="contact-info-title">Skype:</p>
                  <a href="/" className="contact-info-description">@yourusername</a>
                </div>
                <div className="contact-info-main-block">
            ...
            <div className="contact-info-block">
              <div className="contact-info-image-block">
                <img src={Ellipse} alt="" />
                <img className="contact-info-icon" src={SupportImage} alt="" />
              </div>
              <div className="contact-info-main">
                <div className="contact-info-main-block">
                  <p className="contact-info-title">Support services:</p>
                  <a href="/" className="contact-info-description">15369</a>
                </div>
                <div className="contact-info-main-block">
